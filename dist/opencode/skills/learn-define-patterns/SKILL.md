...
| **Ask write target** | Ask the user which AGENTS.md to write to: project AGENTS.md, user `~/.opencode/AGENTS.md`, or both. Never assume. |
...
- Choice of write target: project AGENTS.md, user `~/.opencode/AGENTS.md`, or both
